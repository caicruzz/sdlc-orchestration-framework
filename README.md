...
Path A: No TDD exists             Path B: TDD already exists
  ...
  └───────(No)── TDD Approved?
                 ...
                 (Yes)
                   │
                   ▼
         Human Gate 1: TDD Approval
                   │
                   ▼
               [Planner]
                   │
     creates tasks with Gherkin scenarios
                   │
                   ▼
         Human Gate 2: Review Task Plan
                   │
                   ▼
             Parallel Fork <─────────────────────┐
                   │                             │
